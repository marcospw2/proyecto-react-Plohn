...
function Accesorios() {
    document.title = 'Markitos Ingenieria - Accesorios';
        ...
        <div className="container marketing">
          ...
          <div className="row featurette">
            ...
            <div className="col-md-5">
              <img src={asesor} className="img-fluid mx-auto rounded" alt="Asesor Markitos" />
            </div>
          </div>
          <hr className="featurette-divider" />
          <div className="row featurette">
            ...
            <div className="col-md-5 order-md-1">
              <img src={repair} className="img-fluid mx-auto rounded" alt="Técnico Markitos" />
            </div>
          </div>
          <hr className="featurette-divider" />
          <div className="row featurette">
            ...
            <div className="col-md-5">
              <img src={smartnew} className="img-fluid mx-auto rounded" alt="Crédito Markitos" />
            </div>
          </div>
          <hr className="featurette-divider" />
