  ...
  return (
    ...
    <HashRouter>
      ...
      <Routes>
        ...
        <Route path="/" element={<ItemListContainer greeting="Menú de Markitos Electro"/>} />
        <Route path="/cart" element={<CartView greeting="Este es su carrito"/>} / >
        {/* <Route path="/coderhouse-react" exact component={<ItemListContainer greeting="Bienvenido a Markitos Electro!"/>} /> */}
